...
description: Full usage details for every xtrace CLI command — shared commands, knowledge base admin, and x-vec data commands.
---

This page provides usage details for all CLI commands. See the [CLI quickstart](/x-vec/cli) for installation and first-time setup.
