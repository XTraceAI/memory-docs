---
title: LLM inference
description: Run an LLM over retrieved context for RAG pipelines — with OpenAI, Anthropic, private TEE inference via Redpill, or fully local Ollama.
---
...
For supported models, refer to the [OpenAI documentation](https://platform.openai.com/docs/models).
...
For supported models, refer to the [Anthropic documentation](https://docs.anthropic.com/en/docs/about-claude/models).
...
Create an API key at [redpill.ai](https://redpill.ai/). For the full model list and pricing, see the [Redpill docs](https://docs.redpill.ai/).
