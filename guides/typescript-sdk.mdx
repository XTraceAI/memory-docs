...
**Required body fields**: `messages`, `user_id`, `conv_id`. Optional: `agent_id`, `app_id`, `metadata`, `extract_artifacts` (defaults to `true` — pass `false` to skip the artifact-extraction stage).
